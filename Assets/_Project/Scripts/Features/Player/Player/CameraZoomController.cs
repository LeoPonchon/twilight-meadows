...
public class CameraZoomController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (playerInput == null)
        {
            if (sceneContext == null)
            {
                Debug.LogError("CameraZoomController: Missing SceneContext in scene.", this);
                enabled = false;
                return;
            }
    ...
    void Update()
    {
        if (virtualCamera == null)
        {
            Debug.LogError("CameraZoomController: virtualCamera is null!");
            return;
        }
        
        if (playerInput == null)
        {
            Debug.LogError("CameraZoomController: playerInput is null!");
            return;
        }
